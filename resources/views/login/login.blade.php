    ...
    <div class="wrapper">
        ...
        <div class="form-wrapper sign-up">
            <form action='{{route('admin.login.submit')}}' method="post">
                ...
                <!-- Remember Me Checkbox -->
<div class="input-group" >
    <input type="checkbox" name="remember" id="remember" style="align-item:center;width: 16px; height: 16px; cursor: pointer;">
    Remember Me
</div>
                ...
                <div class="sign-link">
                    <p><a href="#" class="signIn-link">STUDENT LOGIN</a></p>
                </div>
        ...
        <div class="form-wrapper sign-in">
            <form action="{{route('student.login.submit')}}" method="post">
              ...
              <input type="hidden" class="form-control" name="id" id="" aria-describedby="helpId" placeholder=""/>
                ...
                <button type="submit" class="btn">Login</button>
                <div class="sign-link">
                    <p><a href="#" class="signUp-link">ADMIN LOGIN</a></p>
                </div>
            </form>
        </div>
    </div>
